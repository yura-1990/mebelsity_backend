    ...
    <div class="col-10 overflow-scroll">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h1 class="">Loft Office Mebels</h1>
            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content modal-form" method="POST"  id="modal-form" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Loft Office Mebels</h5>
        ...
        $(document).on('click', '.deleteData', function (e) {
            ...
            if (confirm('Are you sere to delete this data')) {
                $.ajax({
                    type:"DELETE",
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    url: `{{ url('/loftmebel/destroy/${dataId}') }}`,
                    data:{
                        '_method':'delete',
                        '_token':'{{ csrf_token() }}',
                    },
