...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('all_office_furniture', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained()->onDelete('cascade')->onDelete('cascade');;
            $table->foreignId('toggle_id')->constrained('toggles')->onDelete('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('all_office_furniture');
    }
};
